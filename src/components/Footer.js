            ...
            <div>
                ...
                <div id={styles.parte2}>
                    <div className="d-flex flex-column bd-highlight mb-3" id={styles.contenedorFooter2}>
                        ...
                        <div class="d-flex justify-content-center"><h6 onMouseEnter={colorear} onMouseLeave={NoColorear} className="text-light"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-instagram" viewBox="0 0 16 16">
